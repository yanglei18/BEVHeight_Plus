...
def generate_info_kitti(kitti_root, split='train'):
    ...
    for idx in tqdm(range(len(idx_list))):
        ...
        for cam_name in cam_names:
            ...
            height = get_reference_height(denorm)
...
def main():
    ...
    parser.add_argument("--data_root", type=str,
                        default="data/v2x-radar-i-kitti",
    ...
    prefix = "v2x-radar-i"
    train_infos = generate_info_kitti(kitti_root, split='train_het')
    val_infos = generate_info_kitti(kitti_root, split='val_het')
