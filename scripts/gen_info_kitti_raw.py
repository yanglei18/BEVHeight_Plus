...
def generate_info_kitti(kitti_root, split='train'):
    ...
    split_txt = os.path.join(kitti_root, "ImageSets",  "train.txt" if split=='train' else 'test.txt')
...
def main():
    ...
    with open('/proj/usr/lei.yang/kitti_dataset/kitti_12hz_infos_raw_data.pkl','wb') as fid:
