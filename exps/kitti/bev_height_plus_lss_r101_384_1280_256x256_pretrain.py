...
return_depth = True
data_root = "/data/kitti_dataset//"
gt_label_path = "/data/kitti_dataset//training/label_2"
...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='./outputs/bev_height_plus_lss_r101_384_1280_256x256_pretrain/checkpoints', filename='{epoch}', every_n_epochs=8, save_weights_only=True, save_last=True, save_top_k=-1)
    ...
    if args.evaluate:
        ...
        backup_codebase(os.path.join('./outputs/bev_height_plus_lss_r101_384_1280_256x256_pretrain', 'backup'))
...
def run_cli():
    ...
    parser.set_defaults(
        ...
        precision=32,
        default_root_dir='./outputs/bev_height_plus_lss_r101_384_1280_256x256_pretrain')
