...
def main(args: Namespace) -> None:
    ...
    if args.evaluate:
        ...
        backup_codebase(os.path.join('./outputs/bev_height_plus_lss_r101_864_1536_256x256', 'backup'))
...
def run_cli():
    ...
    parser.set_defaults(
        ...
        precision=32,
        default_root_dir='./outputs/bev_height_plus_lss_r101_864_1536_256x256')
