...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='./outputs/bev_height_lss_r101_864_1536_256x256_102/checkpoints', filename='{epoch}', every_n_epochs=5, save_last=True, save_top_k=-1)
    ...
    if args.evaluate:
        ...
        backup_codebase(os.path.join('./outputs/bev_height_lss_r101_864_1536_256x256_102', 'backup'))
        '''
...
def run_cli():
    ...
    parser.set_defaults(
        ...
        precision=32,
        default_root_dir='./outputs/bev_height_lss_r101_864_1536_256x256_102')
