...
return_depth = False
data_root = "data/v2x-radar-i-kitti/"
gt_label_path = "data/v2x-radar-i-kitti/training/label_2"
...
class BEVHeightPlusLightningModel(LightningModule):
    ...
    def train_dataloader(self):
        train_dataset = NuscMVDetDataset(
            ...
            info_path=os.path.join(data_root, 'v2x-radar-i_12hz_infos_train_het.pkl'),
            is_train=True,
    ...
    def val_dataloader(self):
        val_dataset = NuscMVDetDataset(
            ...
            classes=self.class_names,
            data_root=self.data_root,
            info_path=os.path.join(data_root, 'v2x-radar-i_12hz_infos_val_het.pkl'),
            is_train=False,
            img_conf=self.img_conf,
            num_sweeps=self.num_sweeps,
            sweep_idxes=self.sweep_idxes,
